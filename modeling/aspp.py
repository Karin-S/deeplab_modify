...
class ASPP(nn.Module):
    def __init__(self, backbone, output_stride, BatchNorm):
        ...
        self.aspp2 = _ASPPModulespecial(inplanes, 256, 3, padding=dilations[1], dilation=dilations[1], BatchNorm=BatchNorm)
        self.aspp3 = _ASPPModulespecial(inplanes, 256, 3, padding=dilations[2], dilation=dilations[2], BatchNorm=BatchNorm)
